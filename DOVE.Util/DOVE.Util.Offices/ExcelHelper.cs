...
namespace DOVE.Util.Offices
{
    /// <summary>
    ///版 本 V1.0
    ///Copyright (c) 2010-2015 鸽子队足球俱乐部　　　　　　　　　　　　　　　　　　　　　　　　　　
    ///创建人：刘晓雷
    ///日 期：2015/11/25
    ...
    public class ExcelHelper
    {
        ...
        public static MemoryStream ExportMemoryStream(DataTable dtSource, ExcelConfig excelConfig)
        {
            ...
            for (int i = 0; i < dtSource.Columns.Count;)
            {
                ...
                //if (excelConfig.ColumnEntity[colint].Column != column.ColumnName)  // 注释 by zy 原有的方法有溢出异常，改为下面的写法
                if (excelConfig.ColumnEntity.Find(s => s.Column == column.ColumnName) == null)
                {
            ...
            #region 右击文件 属性信息
            {
                ...
                si.Author = "张勇"; //填加xls文件作者信息
                si.ApplicationName = "鸽子队科技"; //填加xls文件创建程序信息
                si.LastAuthor = "张勇"; //填加xls文件最后保存者信息
                si.Comments = "张勇"; //填加xls文件作者信息
