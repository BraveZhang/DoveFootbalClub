...
namespace DOVE.Util
{
    ...
    public class Time
    {
        ...
        #region 根据某年的第几周获取这周的开始日期 add by zy 20171010
        /// <summary>
        /// 根据某年的第几周获取这周的开始日期
        /// </summary>
        /// <param name="year"></param>
        /// <param name="weekOrder"></param>
        /// <returns></returns>
        public static DateTime WeekRangeStartDate(int year, int weekOrder)
        {
            //当年的第一天
            var firstDay = new DateTime(year, 1, 1);
            ...
            var firstDate = firstDay.AddDays(dayDiff).Date;
        ...
        #region 根据某年的第几周获取这周的结束日期 add by zy 20171010
        /// <summary>
        /// 根据某年的第几周获取这周的结束日期
        /// </summary>
        /// <param name="year"></param>
        /// <param name="weekOrder"></param>
        /// <returns></returns>
        public static DateTime WeekRangeEndDate(int year, int weekOrder)
        {
            //当年的第一天
            var firstDay = new DateTime(year, 1, 1);
            ...
            var lastDate = firstDay.AddDays(dayAdd).Date;
        ...
        #region 根据某年的第几月获取这月的起止日期 add by zy 20171010
        /// <summary>
        /// 根据某年的第几月获取这月的起止日期
        /// </summary>
        /// <param name="year"></param>
        /// <param name="monthOrder"></param>
        /// <param name="firstDate"></param>
        /// <param name="lastDate"></param>
        /// <returns></returns>
        public static void MonthRange(int year, int monthOrder, ref DateTime firstDate, ref DateTime lastDate)
        {
            // 当月有多少天
            int days = GetDaysOfMonth(year, monthOrder);
            // 当月的第一天
            firstDate = new DateTime(year, monthOrder, 1);
            // 当月的最后一天
            lastDate = firstDate.AddDays(days - 1);
        }
        #endregion

        #region 根据某年获取这年的起止日期 add by zy 20171010
        /// <summary>
        /// 根据某年获取这年的起止日期
        /// </summary>
        /// <param name="yearOrder"></param>
        /// <param name="firstDate"></param>
        /// <param name="lastDate"></param>
        /// <returns></returns>
        public static void YearRange(int yearOrder, ref DateTime firstDate, ref DateTime lastDate)
        {
            // 当年有多少天
            int days = GetDaysOfYear(yearOrder);
            // 当年的第一天
            firstDate = new DateTime(yearOrder, 1, 1);
            // 当年的最后一天
            lastDate = firstDate.AddDays(days - 1);
        }
        #endregion
