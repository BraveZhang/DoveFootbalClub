...
using DOVE.Util.WeChat.Model;
using DOVE.Util.WeChat.Model.Request;
using DOVE.Util.WeChat.Model.Request.SendMessage;
using DOVE.Util;
using DOVE.Util.WeChat.Helper;

namespace DOVE.Util.WeChat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        {
            //        description="测试新闻",
            //        picurl="http://www.DOVE.cn/images/banner3.jpg",
            //        url="http://www.DOVE.cn/fdms/index.html",
            //        title="鸽子队在线"
            //        },
            //                            new SendNews.SendItem
            //        {
