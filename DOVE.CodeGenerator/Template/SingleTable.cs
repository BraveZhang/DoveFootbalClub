...
namespace DOVE.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 6.1
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("using DOVE.Application.Code;\r\n\r\n");

            sb.Append("namespace DOVE.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 鸽子队足球俱乐部\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using DOVE.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace DOVE.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 鸽子队足球俱乐部\r\n");
        ...
        /// <summary>
        /// 生成Oracle实体映射类 add by zy 20170918 
        /// </summary>
        /// <param name="baseConfigModel">基本信息</param>
        /// <returns></returns>
        public string EntityMapBuilder_Oracle(BaseConfigModel baseConfigModel, IEnumerable<DataBaseTableFieldEntity> tableFields)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using DOVE.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace DOVE.Application.Oracle.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 鸽子队足球俱乐部\r\n");
            ...
            sb.Append("        public " + baseConfigModel.MapClassName + "()\r\n");
            sb.Append("        {\r\n");
            sb.Append("            #region 表、字段、主键\r\n");
            sb.Append("            //表\r\n");
            sb.Append("            this.ToTable(\"" + baseConfigModel.DataBaseTableName.ToUpper() + "\");\r\n");
            sb.Append("            //字段\r\n");
            foreach (var item in tableFields)
            {
                sb.Append("            this.Property(x => x." + item.column + ").HasColumnName(\"" + item.column.ToUpper() + "\");\r\n");
            }
            sb.Append("            //主键\r\n");
            sb.Append("            this.HasKey(t => t." + baseConfigModel.DataBaseTablePK + ");\r\n");
            sb.Append("            #endregion\r\n\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using DOVE.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using DOVE.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using DOVE.Data;\r\n");
            sb.Append("using DOVE.Data.Repository;\r\n");
            sb.Append("using DOVE.Util;\r\n");
            sb.Append("using DOVE.Util.WebControl;\r\n");
            sb.Append("using DOVE.Util.Extension;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n");
            sb.Append("using System.Text;\r\n");
            sb.Append("using System.Data.Common;\r\n");
            sb.Append("using System.Data;\r\n\r\n");
            sb.Append("namespace DOVE.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 鸽子队足球俱乐部\r\n");
            ...
            if (baseConfigModel.gridModel.IsPage == true)
            {
                ...
                sb.Append("        public DataTable GetPageList(Pagination pagination, string queryJson)\r\n");
                sb.Append("        {\r\n");
                //sb.Append("            return this.BaseRepository().FindList(pagination);\r\n");
                //-----------------------add by zy 20171011------------------>>>>>>>>>>>>>>>>>>>>>>>>>>>
                sb.Append("           try\r\n");
                sb.Append("           {\r\n");
                sb.Append("                var strSql = new StringBuilder();\r\n");
                sb.Append("                strSql.Append(@\"SELECT w.* from " + baseConfigModel.DataBaseTableName + " w WHERE 1 = 1 \");\r\n");
                sb.Append("                var parameter = new List<DbParameter>();\r\n");
                sb.Append("                var queryParam = queryJson.ToJObject();\r\n");
                sb.Append("                if (!queryParam[\"StartTime\"].IsEmpty() && !queryParam[\"EndTime\"].IsEmpty())\r\n");
                sb.Append("                {\r\n");
                sb.Append("                    strSql.Append(\" AND w.Time Between \" + DbParameters.CreateDbParmCharacter() + \"StartTime AND \" + DbParameters.CreateDbParmCharacter() + \"EndTime \");\r\n");
                sb.Append("                    parameter.Add(DbParameters.CreateDbParameter(DbParameters.CreateDbParmCharacter() + \"StartTime\", (queryParam[\"StartTime\"].ToString() + \" 00:00:00\").ToDate()));\r\n");
                sb.Append("                    parameter.Add(DbParameters.CreateDbParameter(DbParameters.CreateDbParmCharacter() + \"EndTime\", (queryParam[\"EndTime\"].ToString() + \" 23:59:59\").ToDate()));\r\n");
                sb.Append("                }\r\n");
                sb.Append("                return this.BaseRepository().FindTable(strSql.ToString(), parameter.ToArray(), pagination);\r\n");
                sb.Append("           }    \r\n");
                sb.Append("           catch     \r\n");
                sb.Append("           {     \r\n");
                sb.Append("                throw;\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Data;\r\n\r\n");
            sb.Append("namespace DOVE.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 鸽子队足球俱乐部\r\n");
            ...
            if (baseConfigModel.gridModel.IsPage == true)
            {
                ...
                sb.Append("        DataTable GetPageList(Pagination pagination, string queryJson);\r\n");// add by zy 20171011
            }
            sb.Append("        /// <summary>\r\n");
            sb.Append("        /// 获取列表\r\n");
            sb.Append("        /// </summary>\r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using DOVE.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using DOVE.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using DOVE.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using DOVE.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n");
            sb.Append("using System.Data;\r\n\r\n");

            sb.Append("namespace DOVE.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 鸽子队足球俱乐部\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using DOVE.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using DOVE.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using DOVE.Util;\r\n");
            sb.Append("using DOVE.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace DOVE.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 鸽子队足球俱乐部\r\n");
        ...
        public string IndexBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("        var queryJson = $(\".title-search\").GetWebControls();\r\n");// add by zy 20171011
            ...
            if (colModel != null)
            {
                foreach (GridColumnModel entity in colModel)
                {
                    ...
                    sb.Append("                { label: '" + entity.label + "', name: '" + entity.name.ToLower() + "', index: '" + entity.name.ToLower() + "', width: " + entity.width + ", align: '" + entity.align + "',sortable: " + entity.sortable.ToString().ToLower() + " " + IsShow_Field(entity.hidden) + " },\r\n");// add by zy 20171011 name和index变为小写
                }
            }
            sb.Append("            ],\r\n");
            if (baseConfigModel.gridModel.IsPage == true)
            ...
            sb.Append("            }\r\n");
            sb.Append("        });\r\n");
            sb.Append("        $gridTable.authorizeColModel();\r\n");// add by zy 20171011 列权限
            sb.Append("    }\r\n");
            sb.Append("    //新增\r\n");
            ...
            sb.Append("        dialogOpen({\r\n");
            sb.Append("             id: \"PrintPageDialog\",\r\n");
            sb.Append("             title: '打印当前页',\r\n");
            sb.Append("             url: '/Utility/PrintPage',\r\n");
            sb.Append("             width: \"1200px\",\r\n");
            sb.Append("             height: \"500px\",\r\n");
            sb.Append("             callBack: function (iframeId) {\r\n");
            sb.Append("                top.frames[iframeId].SubmitPrint();\r\n");
            sb.Append("             }, btn: ['打印', '关闭']\r\n");
            sb.Append("        });\r\n");
            sb.Append("    }\r\n");
            sb.Append("    //要打印数据源，子页面调用的函数\r\n");
            sb.Append("    function PrintDataSource () {\r\n");
            sb.Append("        var $printArea = $('.printArea');\r\n");
            sb.Append("        return $printArea;\r\n");
            sb.Append("    }\r\n");
            sb.Append("    //导出\r\n");
            ...
            sb.Append("    }\r\n");
            sb.Append("    //查询表格函数\r\n");
            sb.Append("    function SearchEvent() {\r\n");
            //sb.Append("        var queryJson = $(\"#filter-form\").GetWebControls();\r\n");
            sb.Append("        var queryJson = $(\".title-search\").GetWebControls();\r\n"); //add by zy 20171011
            ...
            //sb.Append("            </tr>\r\n");
            //sb.Append("        </table>\r\n");
            sb.Append("        @*时间用户控件分部页面*@\r\n");// add by zy 20170926 用户控件
            sb.Append("        @Html.Partial(\"_UserControlTime\")\r\n");// add by zy 20170926 用户控件
            sb.Append("    </div>\r\n");
            ...
            sb.Append("        </div>\r\n");
            sb.Append("        <script>$('.toolbar').authorizeButton()</script>\r\n");// add by zy 20170926 增加权限管控
            sb.Append("    </div>\r\n");
            sb.Append("</div>\r\n");
            sb.Append("<div class=\"gridPanel\" id=\"gridPanel\">\r\n");
            sb.Append("    <div class=\"printArea\">\r\n");
