...
namespace DOVE.Application.Web.Areas.DoveManage.Controllers
{
    ...
    /// 描 述：活动信息表
    /// </summary>
    public class T_ActivityController : MvcControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult T_ActivityIndex()
        {
            return View();
        }
        /// <summary>
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult T_ActivityForm()
        {
            return View();
        }
        /// <summary>
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            var data = t_activitybll.GetPageList(pagination, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = t_activitybll.GetList(queryJson);
        ...
        {
            var data = t_activitybll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        #endregion
        ...
        {
            t_activitybll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        /// <summary>
        /// 保存表单（新增、修改）
